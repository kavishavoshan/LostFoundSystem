...
import MessagingRedirect from "./pages/MessagingRedirect";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/messaging" element={<MessagingRedirect />} />
        ...
        {/* Admin Routes */}
        <Route path="/admin" element={<AdminDashboard />} /> {/* Changed route to /admin and element to AdminDashboard */}
