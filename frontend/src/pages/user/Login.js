...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add a small delay to ensure token is properly stored and authentication state is updated
      ...
      console.log(`[Login] Token before navigation: ${token ? 'Token exists' : 'No token'}`);
